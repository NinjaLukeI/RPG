...
function Selection:Create(params)
	...
	local this =
	{	
		--menu pos from top left corner
		mX = 0,
		mY = 0,
		mDataSource = params.data, --list of items to be displayed
		mColumns = params.columns or 1,
		mFocusX = 1, --what column is selected
		mFocusY = 1, --what elemnt in the column is selected
		mSpacingY = params.spacingY or 24, --vertical space in px for row in selec list
		mSpacingX = params.spacingX or 128, -- horizontal space
